...
(0, 'cache', 'cache_products' '1', 0),
(0, 'cache', 'cache_categories' '1', 0),
(0, 'cache', 'cache_filter_pages' '1', 0),
(0, 'cache', 'cache_filter_list' '1', 0),
(0, 'cache', 'cache_module' '1', 0),
(0, 'cache', 'cache_header' '1', 0),
(0, 'cache', 'cache_footer' '1', 0),
(0, 'theme_default', 'theme_default_product_limit', '15', 0),
(0, 'theme_default', 'theme_default_product_description_length', '255', 0),
(0, 'theme_default', 'theme_default_image_thumb_width', '228', 0),
(0, 'theme_default', 'theme_default_image_thumb_height', '228', 0),
(0, 'theme_default', 'theme_default_image_main_width', '2000', 0),
(0, 'theme_default', 'theme_default_image_main_height', '2000', 0),
(0, 'theme_default', 'theme_default_image_category_width', '500', 0),
...
CREATE TABLE `oc_seo_tag_to_store` (
  ...
  `show_as_facet`       TINYINT NOT NULL DEFAULT '0',
  `date_added`          DATETIME NOT NULL DEFAULT (CURRENT_TIMESTAMP),
  `date_modified`       DATETIME NOT NULL DEFAULT (CURRENT_TIMESTAMP),
