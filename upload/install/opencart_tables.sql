...
CREATE TABLE `oc_facet_index` (
  `product_id`      INT NOT NULL,
  `store_id`        INT NOT NULL,
  `facet_type`      ENUM('category_id', 'manufacturer_id', 'option', 'attribute', 'filter', 'tag', 'supplier_id', 'is_available', 'has_discount', 'is_featured', 'bestseller', 'latest', 'top_rated') NOT NULL,
...
CREATE TABLE oc_facet_name (
  ...
  `facet_type`        ENUM('category_id', 'manufacturer_id', 'option', 'attribute', 'filter', 'tag', 'supplier_id', 'is_available', 'has_discount', 'is_featured') NOT NULL,
