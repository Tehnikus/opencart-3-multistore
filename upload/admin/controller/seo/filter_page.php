...
class ControllerSeoFilterPage extends Controller {
  ...
  public function __construct($registry) {
    ...
    foreach ($facetTypes as $facetId => $facet) {
      $this->facetTypes[$facetId] = [
        'title'      => $this->language->get("type_" . $facet['facetType']),
        'facetType'  => $facetId,
        'required'   => false,
